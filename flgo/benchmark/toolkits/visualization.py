...
def visualize_by_vul(generator, partitioner, task_path:str):
    r"""
    ...
    all_labels = [d['cwe_cls'] for d in generator.train_data]
    ...
    if hasattr(partitioner, 'dirichlet_dist'):
        ...
        for cid, cidxs in enumerate(generator.local_datas):
            ...
            labels = [int(generator.train_data[did]['cwe_cls']) for did in cidxs]
