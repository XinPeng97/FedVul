...
class BasicTaskCalculator(AbstractTaskCalculator):
    ...
    def get_optimizer(self, model=None, lr=0.1, weight_decay=0, momentum=0):
        ...
        if self.optimizer_name.lower() == 'adamw':
            OPTIM = getattr(importlib.import_module('transformers'), self.optimizer_name)
...
class FromDatasetGenerator(BasicTaskGenerator):
    ...
    def partition(self, *args, **kwargs):
        ...
        self.local_datas = self.partitioner(self.train_data) # 这里调用 <flgo.benchmark.partition.DiversityPartitioner object at 0x7257c8144550>
