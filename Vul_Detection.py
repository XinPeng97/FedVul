...
from flgo.experiment.logger.vd_logger import VDLogger
...
if __name__ == '__main__':
    ...
    task_config = {
        ...
        'partitioner':{'name': 'VLDiversityPartitioner','para':{'num_clients':10, 'diversity':1.0, "index_func": lambda X:[xi['cwe_cls'] for xi in X]}}
    } 
    ...
    runner = flgo.init(task, algo, option, model=model, Logger=VDLogger)
    runner.run()
